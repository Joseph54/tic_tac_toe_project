...
if (isset($_POST['submit'])) {
    ...
    if ($blank == 1 && $winner == 'n') {
        ...
        if (count($place = location($sqr, 'o', 3)) == 3) {
...
<form action="tic_tac_toe.php" method="post">
    ...
    <?php for($i=0; $i<9; $i++) { ?>
        <input class="highlight" type="text" pattern="[xo]{1}" name="box<?php echo $i; ?>" value="<?php echo $sqr[$i]; ?>" size="2" <?php echo $readonly[$i]; ?>>
   ...
   <button type="submit" name="reset" value="reset">play again</button>
    ...
    <button type="submit" name="friend" value="friend" formaction="tic_tac_toe_2.php">play with friend</button>
</form>
